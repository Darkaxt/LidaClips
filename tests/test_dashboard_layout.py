...
class DashboardLayoutTests(unittest.TestCase):
    def test_main_dashboard_uses_full_height_work_surface(self):
        ...
        self.assertIn('id="dashboard-coverage"', template)
        self.assertLess(template.index('id="dashboard-coverage"'), template.index('id="dashboard-rollout"'))
        ...
        self.assertIn("dashboardCoverage.textContent", script)
        self.assertIn("coverage_percent", script)
